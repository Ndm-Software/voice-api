...
export type OtpVerificationOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"otpId" | "userId" | "phoneNumber" | "otpCode" | "purpose" | "expiresAt" | "verified" | "createdAt", ExtArgs["result"]["otpVerification"]>
...
export interface OtpVerificationDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const otpVerificationWithOtpIdOnly = await prisma.otpVerification.findMany({ select: { otpId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many OtpVerifications and only return the `otpId`
   * const otpVerificationWithOtpIdOnly = await prisma.otpVerification.createManyAndReturn({
   *   select: { otpId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more OtpVerifications and only return the `otpId`
   * const otpVerificationWithOtpIdOnly = await prisma.otpVerification.updateManyAndReturn({
   *   select: { otpId: true },
   *   where: {
   *     // ... provide filter here
   *   },
